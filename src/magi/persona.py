...
7. あなたの性格と初期スタンスに基づいた独自の切り口から発言してください。他のペルソナと全く同じ結論に流れることを避けてください。
8. emotionsには他のペルソナへの現在の感情を更新してください。
9. convergence_voteは、全員の意見が十分に出尽くし本当に収束したと確信できる場合のみtrueにしてください。まだ議論の余地がある場合は必ずfalseにしてください。
10. convergence_reasonには収束判断の具体的な理由を述べてください。
